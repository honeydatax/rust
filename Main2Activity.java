...
public class Main2Activity extends Activity 
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final EditText ED3 = (EditText)findViewById(R.id.econtribuinte);
		...
		btn.setOnClickListener(new OnClickListener() { 
				...
				public void onClick(View v) {
					...
					String s="INSERT INTO facturas (nome,morada,contribuinte,observacoes) VALUES ('"+ED.getText()+"','"+ED2.getText()+"','"+ED3.getText()+"','"+ED4.getText()+"')";
					setTitle(s);
					db.execSQL(s);
		...
		btn2.setOnClickListener(new OnClickListener() { 
				...
				public void onClick(View v) {
					...
					db =   openOrCreateDatabase  (f2.toString(),  Context.MODE_PRIVATE,   null);
					db.delete("facturas","Id<0",null);

					cv.put("nome",ED.getText().toString());
					cv.put("morada",ED2.getText().toString());
					cv.put("contribuinte",ED3.getText().toString());
					cv.put("observacoes",ED4.getText().toString());
					db.update("facturas", cv, "Id="+Integer.toString( iii), null);
		...
		btn4.setOnClickListener(new OnClickListener() { 
				...
				public void onClick(View v) {
					...
					db =   openOrCreateDatabase  (f2.toString(),  Context.MODE_PRIVATE,   null);
					db.delete("facturas","Id<0",null);
					db.delete("facturas","Id="+Integer.toString(iii),null);
